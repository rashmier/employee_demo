...
- Better generation of EmployeeNo, This requirement typically should be discussed by the team to properly proceed on how to implement the said autogeneration and because format will depend on by-client basis. For this demo, I opted to use employeeNo as a primary key to make things simple.
